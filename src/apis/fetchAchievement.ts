...
import { IBaekjoonCrawlingData, ICustomBaekjoonCrawlingData } from '@/types/common/baekjoon';
import { ICommonResponse, ResponseData } from '@/types/common/response';
import { AxiosResponse } from 'axios';

const fetchAchievement = async (baekjoon_id:string): Promise<ResponseData<ICustomBaekjoonCrawlingData[]>> =>
